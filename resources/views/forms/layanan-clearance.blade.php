...
<body class="bg-back">
    ...
    {{-- <section class="max-w-6xl mx-auto py-12">
        <div class="flex flex-col gap-y-2 text-center mb-10">
          ...
          <form method="POST" action="{{ route('form.submitclearance') }}" class="mx-auto max-w-4xl" enctype="multipart/form-data">
            @csrf
              ...
              <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-6 gap-x-6 gap-y-8">
                  <div class="col-span-3">
                    ...
                    <div class="mt-2">
                      <input type="text" name="applicant" id="applicant" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-700 ">
                    </div>
                  </div>
                  ...
                  <div class="col-span-3">
                    ...
                    <div class="mt-2">
                      <input type="text" name="instansi" id="instansi" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-700 ">
                    </div>
                  </div>
