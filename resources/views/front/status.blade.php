          ...
          <form method="POST" action="{{ route('front.status.details') }}" class="mx-auto max-w-4xl">
            ...
            <div class="space-y-12">
              ...
              <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8">
                  <div class="col-span-1">
                    ...
                    <div class="mt-2">
                      <input required type="text" name="receipt" id="receipt" placeholder="Masukan Resi Pengajuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary ">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" class="rounded-full bg-primary px-5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cek status</button>
              </div>
          </form>
    </section>
@endsection