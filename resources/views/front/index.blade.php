...
<body class="bg-back">
     ...
     <section class="max-w-6xl mx-auto py-12">
      <div class="flex flex-row justify-between items-center">
        <div class="flex flex-col gap-y-6">
          <div class="small-badge w-fit gap-x-2 flex flex-row bg-white rounded-full py-2 px-4">
            ...
            <p class="text-base font-semibold text-indigo-950">Dapat di akses secara Online 24 Jam</p>
          </div>
          <div class="flex flex-col gap-y-2">
            <h1 class="font-clash text-6xl font-extrabold text-indigo-950 leading-none">Portal Layanan<br>Digitalisasi SKPD</h1>
            <p class="text-base leading-loose text-gray-500">Pengajuan dan Pengadaan TIK, Solusi Server, Perangkat, serta Dukungan <br> untuk Optimalisasi  Kinerja dan Efisiensi bagi SKPD Kabupaten Pekalongan</p>
          </div>
          <a href="#" class=" w-fit text-base bg-violet-700 text-white py-2 rounded-full font-semibold px-10 hover:bg-indigo-950 transition-all ease-in-out duration-300">Mulai</a>
        </div>
        <div class="flex flex-row items-center">
          <img src="./assets/hero-image-2.png" class="h-[480px]" alt="hero-image">
        </div>
      </div>
    ...
    <!-- Features -->
     <section id="features" class="features max-w-6xl mx-auto py-12">
      <h3 class="text-5xl text-indigo-950 font-clash font-bold text-center mb-8">Layanan Tersedia</h3>
      ...
      @foreach ($services as $service)
        <div class="flex flex-col gap-y-5 bg-white rounded-2xl p-6">
          ...
          <a href="#" class="font-semibold text-violet-700 hover:bg-slate-200 p-2 w-fit rounded-md">Pengajuan</a>
        </div>
      @endforeach
    ...
    <!-- about x -->
    <section id="about" class="max-w-6xl mx-auto py-12">
      <div class="flex flex-row justify-between items-center">
        <div class="flex flex-row items-center">
          <img src="./assets/about-image.png" class="h-[480px]" alt="hero-image">
        </div>
        <div class="flex flex-col gap-y-6">
          <div class="small-badge w-fit gap-x-2 flex flex-row bg-white rounded-full py-2 px-4">
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-base font-semibold text-indigo-950">Menampung Pengajuan 24 jam</p>
          </div>
          <div class="flex flex-col gap-y-2">
            <h1 class="font-clash text-6xl font-extrabold text-indigo-950 leading-none">Layanan Konsultasi<br>dan Rekomendasi</h1>
            <p class="text-base leading-loose text-gray-500">Pelayanan terintegrasi untuk SKPD, konsultasikan Pengajuan hosting, VPS, domain,<br> dan penyediaan alat TIK mutakhir untuk efektivitas SKPD yang disediakan oleh</p>
            ...
            <div class="grid grid-cols-4 mt-4">
              ...
              <div class="flex flex-col bg-white rounded-2xl p-8 w-fit">
          ...
          <a href="#" class=" w-fit text-base bg-violet-700 text-white py-2 rounded-full font-semibold px-10 hover:bg-indigo-950 transition-all ease-in-out duration-300">Konsultasi</a>
        </div>
     ...
     <section class=" max-w-6xl mx-auto py-12">
      <div class="flex flex-col gap-y-8">
        <div class="flex flex-col gap-y-2 text-center">
          <h3 class="text-5xl text-indigo-950 font-clash font-bold">Panduan Layanan</h3>
          <p class="text-base leading-loose text-gray-500">Kemudahan Pengajuan yang juga dilengkapi dengan Panduan Penggunaan </p>
        </div>
        <div class="flex flex-warp gap-x-10 justify-center">
          <div class="group relative">
            <div class="group-hover:opacity-100 transition-all ease-in-out duration-300 opacity-0 absolute flex justify-center w-full bottom-8">
            ...
            <img src="./assets/guide-1.png" alt="" class="group-hover:border-4 transition-all ease-in-out duration-300 border-violet-700 rounded-2xl w-[320px] h-[220px]"> 
          </div>
          <div class="group relative">
            <div class="group-hover:opacity-100 transition-all ease-in-out duration-300 opacity-0 absolute flex justify-center w-full bottom-8">
              <a href="#" class="font-semibold bg-violet-700 text-white px-7 py-3 shadow-violet-700 rounded-full hover:bg-indigo-950 transition-all ease-in-out duration-300">View Detail</a>
