...
<body class="bg-back">
    ...
    <!-- navbar -->
     <nav class="flex mx-auto max-w-6xl mt-10 sm:max-w-sm">
        <ul class="flex flex-row justify-between gap-x-10 mx-auto">
          ...
          <li>
            <a href="{{ route('front.index') }}" class="text-base font-semibold text-violet-700 hover:bg-slate-200 p-2 rounded-md">Tentang</a>
          </li>
        </ul>
     </nav>
    <!-- navbar -->
      ...
      <div class="flex flex-row justify-between items-center sm:flex-col sm:gap-y-4 md:flex-col">
        <div class="flex flex-col gap-y-6">
          ...
          <div class="flex flex-col gap-y-2 sm:text-center md:text-center">
            <h1 class="font-clash text-6xl font-extrabold text-indigo-950 leading-none sm:text-4xl md:text-5xl">Portal Layanan<br>Digitalisasi SKPD</h1>
            <p class="max-w-md text-base leading-loose text-gray-500 sm:text-xs sm:max-w-xs">Pengajuan Clearance, Solusi Server, Perangkat, serta Dukungan untuk Optimalisasi  Kinerja dan Efisiensi bagi OPD Kabupaten Pekalongan</p>
          </div>
          <a href="#features" class=" w-fit text-base bg-violet-700 text-white py-2 rounded-full font-semibold px-10 hover:bg-indigo-950 transition-all ease-in-out duration-300 sm:mx-auto">Mulai</a>
        </div>
        <div class="flex flex-row items-center">
          <img src="../assets/hero-image-2.png" class="h-[480px] sm:h-[400px] md:h-[380px]" alt="hero-image">
        </div>
      </div>
    ...
    <!-- features -->
     <section id="features" class="features max-w-6xl mx-auto py-12 sm:max-w-sm md:max-w-2xl">
      <div class="gap-y-2 text-center">
        <h3 class="text-5xl text-indigo-950 font-clash font-bold mb-2 sm:text-4xl">Layanan Tersedia</h3>
        <p class="text-base leading-loose text-gray-500 mb-7 sm:text-xs sm:max-w-xs sm:mx-auto">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam, aperiam.</p>
      </div>
      ...
      @foreach ($services as $service)
        ...
        <div class="flex flex-col gap-y-5 bg-white rounded-2xl p-6 sm:items-center sm:text-center sm:max-w-xs sm:mx-auto">
    ...
    <section id="about" class="max-w-6xl mx-auto py-12 sm:max-w-sm md:max-w-2xl">
      <div class="flex flex-row justify-between items-center sm:flex-col sm:gap-y-4 md:flex-col">
        ...
        <div class="flex flex-row items-center">
          <img src="../assets/about-image.png" class="h-[480px] sm:h-[400px] md:h-[400px]" alt="hero-image">
        </div>
        <div class="flex flex-col gap-y-6">
          ...
          <div class="flex flex-col gap-y-2 sm:text-center md:text-center">
            <h1 class="font-clash text-6xl font-extrabold text-indigo-950 leading-none sm:text-4xl md:text-4xl">Layanan Konsultasi<br>dan Rekomendasi</h1>
            <p class="text-base max-w-md leading-loose text-gray-500 sm:text-xs sm:max-w-xs sm:mx-auto">Pelayanan terintegrasi untuk SKPD, konsultasikan Pengajuan hosting, VPS, domain, dan penyediaan alat TIK mutakhir untuk efektivitas SKPD</p>

            <!-- Grid -->

            <div class="grid grid-cols-4 mt-4 sm:mx-auto sm:gap-x-6 sm:gap-y-6 md:mx-auto md:gap-x-6 sm:grid-cols-2">

              <!-- services -->
      
              <div class="flex flex-col bg-white rounded-2xl p-8 w-fit sm:p-5 md:p-6">
          ...
          <a href="#" class="sm:mx-auto md:mx-auto md:mt-4 w-fit text-base bg-violet-700 text-white py-2 rounded-full font-semibold px-10 hover:bg-indigo-950 transition-all ease-in-out duration-300">Konsultasi</a>
        </div>
