...
<div class="flex flex-col gap-y-5 bg-white rounded-2xl p-6">
        ...
        <div class="mt-5 sm:mt-10">
            <ul class="mt-3 mb-3 flex flex-col">
                <li class="inline-flex items-center gap-x-2 py-3 px-4 text-sm border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg">
                    ...
                    <span class="font-semibold">Nama Pengaju</span>
                    <span>{{ $details->applicant }}</span>
                    </div>
                </li>
                <li class="inline-flex items-center gap-x-2 py-3 px-4 text-sm border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg">
                    <div class="flex items-center justify-between w-full">
    ...
    <div class="mt-2 flex items-center justify-center gap-x-6">                  
        ...
        <button class="rounded-full bg-primary px-5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Beranda</button>
        </a>
    </div>
