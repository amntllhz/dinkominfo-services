  ...
  <div class="mt-10 grid grid-cols-6 sm:grid-cols-1 gap-x-6 gap-y-8 sm:gap-y-4">
      ...
      <div class="col-span-3 sm:col-span-1">
        <div class="flex items-center space-x-2">
          <label for="os" class="block text-sm font-medium leading-6 text-gray-900">Operating System<span class="text-red-500">*</span>
          </label>
          <x-popup-info>Isikan dengan Sistem Operasi (contoh : Linux)</x-popup-info>
        </div>
        </div>
        <div class="mt-2">
