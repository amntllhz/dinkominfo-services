...
<h2 class="text-lg font-bold leading-7 text-primary">Data {{ $slot }}</h2>
...
<div class="mt-10 grid grid-cols-6 sm:grid-cols-1 gap-x-6 gap-y-8 sm:gap-y-4">
    ...
    <div class="mt-2">
        <input id="applicant" value="{{ old('applicant') }}" name="applicant" type="text" placeholder="Masukan Nama Lengkap" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary ">
    </div>
    </div>
    ...
    <div class="mt-2">
        <input type="email" name="email" id="email" placeholder="Masukan Email"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary " value="{{ old('email') }}">
    </div>
    </div>
</div>
</div>