...
<div class="pb-12">
<h2 class="text-lg font-bold leading-7 text-primary">Data Laporan</h2>
...
<div class="mt-10 grid grid-cols-6 sm:grid-cols-1 gap-x-6 gap-y-8 sm:gap-y-4">
    ...
    <div class="mt-2">
        <select id="service" name="service" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary">
    ...
    <div class="mt-2">
        <textarea id="report" name="report" rows="3" value="{{ old('report') }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary "></textarea>
    </div>
    ...
    <div class="flex flex-row gap-x-4 h-6 items-center">
        <input id="validasi" name="validasi" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary" required>
