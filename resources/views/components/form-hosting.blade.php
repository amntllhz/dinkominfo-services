<div class="pb-12">
  ...
  <div class="mt-10 grid grid-cols-6 sm:grid-cols-1 gap-x-6 gap-y-8 sm:gap-y-4">
    ...
    <div class="col-span-full">
      ...
      <div class="mt-2">
        <textarea required id="purpose" name="purpose" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary "></textarea>
      </div>
    ...
    <div class="col-span-full">
      ...
      <div class="mt-2">
        <textarea required id="add_inform" name="add_inform" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary "></textarea>
      </div>
    ...
    <div class="mx-auto col-span-full">
      <div class="flex flex-row gap-x-4 h-6 items-center">
        <input id="validasi" name="validasi" type="checkbox" required class="h-4 w-4 rounded border-gray-300 text-primary  focus:ring-primary">
